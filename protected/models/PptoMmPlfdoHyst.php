...
/**
 * This is the model class for table "fzs_ppto_mm_plfdo_hyst".
 *
 * The followings are the available columns in table 'fzs_ppto_mm_plfdo_hyst':
 ...
 */
class PptoMmPlfdoHyst extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('co_ppto_mm_plfdo, co_ppto', 'required'),
			...
			array('co_ppto_mm_plfdo, co_ppto, mnto_1, mnto_2, mnto_3, mnto_4, mnto_5, mnto_6, mnto_7, mnto_8, mnto_9, mnto_10, mnto_11, mnto_12, mnto_ttl, vrsn, fe_crea, fe_modf, usr_crea, usr_modf, in_stat, tx_desc', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 *
	 * Typical usecase:
	 * - Initialize the model fields with values from fipublic function behaviors()
        {
                return array(
	 ...
	 * @return PptoMmPlfdoHyst the static model class
	 */
