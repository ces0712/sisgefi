...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
        ...
        <?php /*
	<div class="row">
		<?php echo $form->labelEx($model,'co_onpe'); ?>
		<?php echo $form->textField($model,'co_onpe'); ?>
		<?php echo $form->error($model,'co_onpe'); ?>
	</div>
        */ ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'accn_epfca'); ?>
		<?php echo $form->textArea($model,'accn_epfca',array('cols'=>45, 'rows'=>10, 'size'=>500,'maxlength'=>500)); ?>
		<?php echo $form->error($model,'accn_epfca'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'poai'); ?>
		<?php echo $form->textField($model,'poai',array('size'=>20,'maxlength'=>20)); ?>
		<?php echo $form->error($model,'poai'); ?>
	</div>
