...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_cls_csto'); ?>
		<?php echo $form->textField($model,'id_cls_csto'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'co_cls_csto'); ?>
		<?php echo $form->textField($model,'co_cls_csto'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'ds_cls_csto'); ?>
		<?php echo $form->textField($model,'ds_cls_csto',array('size'=>60,'maxlength'=>60)); ?>
	</div>
