...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
        ...
        <?php /*
	<div class="row">
		<?php echo $form->labelEx($model,'co_cls_csto'); ?>
		<?php echo $form->textField($model,'co_cls_csto'); ?>
		<?php echo $form->error($model,'co_cls_csto'); ?>
	</div>
        */ ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'ds_cls_csto'); ?>
		<?php echo $form->textField($model,'ds_cls_csto',array('size'=>60,'maxlength'=>60)); ?>
		<?php echo $form->error($model,'ds_cls_csto'); ?>
	</div>
