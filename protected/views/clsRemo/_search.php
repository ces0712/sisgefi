...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_cls_remo'); ?>
		<?php echo $form->textField($model,'id_cls_remo'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'co_cls_remo'); ?>
		<?php echo $form->textField($model,'co_cls_remo'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'ds_cls_remo'); ?>
		<?php echo $form->textField($model,'ds_cls_remo',array('size'=>60,'maxlength'=>60)); ?>
	</div>
