...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_ppto_mm_fmldo'); ?>
		<?php echo $form->textField($model,'id_ppto_mm_fmldo'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'co_ppto_mm_fmldo'); ?>
		<?php echo $form->textField($model,'co_ppto_mm_fmldo'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'por_vrbl_mcrnoca'); ?>
