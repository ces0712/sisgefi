...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_und_mdda'); ?>
		<?php echo $form->textField($model,'id_und_mdda'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'co_und_mdda'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'ds_und_mdda'); ?>
