...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'id_actvd'); ?>
		<?php echo $form->textField($model,'id_actvd'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'co_actvd'); ?>
		<?php echo $form->textField($model,'co_actvd'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'ds_actvd'); ?>
		<?php echo $form->textField($model,'ds_actvd',array('size'=>60,'maxlength'=>60)); ?>
	</div>
